...
```shell
python main.py --img_path data/ava/images --train --train_csv_file data/ava/train_labels.csv --val_csv_file data/ava/val_labels.csv --conv_base_lr 5e-4 --dense_lr 5e-3 --decay --ckpt_path ckpts --epochs 100 --early_stopping_patience 10
```
